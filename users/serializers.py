...
class PasswordResetConfirmSerializer(serializers.Serializer):
    ...
    token = serializers.CharField(help_text="Token UUID de réinitialisation")
...
class PhoneChangeRequestSerializer(serializers.Serializer):
    ...
    def validate_new_phone(self, value):
        ...
        try:
            ...
            # Note: La vérification d'unicité est faite dans le service
            # pour éviter les conditions de course (race conditions)
