...
class UserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Informations de contact", {"fields": ("address", "apartment_name")}),
        (
            "Permissions",
            {
                "fields": (
...
class PhoneWhitelistAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Numéro de téléphone", {"fields": ("phone", "is_active")}),
        (
            "Informations d'ajout",
            {"fields": ("added_by", "added_at"), "classes": ("collapse",)},
        ),
        ("Notes", {"fields": ("notes",)}),
    )
...
class VerificationTokenAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Token", {"fields": ("token", "user", "phone")}),
        ("Type et statut", {"fields": ("verification_type", "is_used")}),
        ("Dates", {"fields": ("created_at", "expires_at"), "classes": ("collapse",)}),
    )
...
class ActivationTokenAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Token d'activation", {"fields": ("user", "code_hash")}),
        ("Statut", {"fields": ("is_locked", "attempts", "send_count")}),
        (
            "Dates",
            {
